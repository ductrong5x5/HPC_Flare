...
if __name__ == "__main__":
    example_name = os.environ.get("EXAMPLE_NAME")
    total_clients = int(os.environ.get("NUM_CLIENTS"))
    system_name = os.environ.get("SYSTEM_NAME")
    job_name = os.environ.get("JOB_NAME")
    assign_folder = os.environ.get("ASSIGN_FOLDER")
    slurm_job_name = os.environ.get("SLURM_JOB_NAME")
    location = os.environ.get("LOCATION")
    username = "admin@ornl.gov"
    base_dir = os.path.join(location, "example",slurm_job_name, example_name)
    admin_user_dir = os.path.join(base_dir, system_name, username)
