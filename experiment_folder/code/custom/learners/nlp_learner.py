...
import pandas as pd
import torch
from custom.models.nlp_models import BertModel, GPTModel,AlBertModel
...
class NLPLearner(Learner):
    ...
    def initialize(self, parts: dict, fl_ctx: FLContext):
        ...
        if self.model_name == "bert-base-uncased":
            self.model = BertModel(model_name="/lustre/orion/csc666/proj-shared/ducnguyen/new_nvflare_edge/AMD_NVFlare/model/bert-base-uncased", num_labels=self.num_labels)
